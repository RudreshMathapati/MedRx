...
const WriteRX = () => {
  ...
  const savePrescription = async () => {
    ...
    try {
      ...
      const prescriptionId = res.data.prescriptionId; // e.g. "RX-HOSP-0001"
      ...
      try {
        ...
        console.warn("SMS/WhatsApp notifications not configured or server skipped", err);
      }
      
      toast.success("Prescription successfully saved and sent! 🚀");
