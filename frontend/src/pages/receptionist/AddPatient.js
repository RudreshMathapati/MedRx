...
const handleSubmit = async (e) => {
  ...
  if (
    ...
    toast.error(
      "Required fields: Name, Phone, Age, and Assigned Doctor"
    );
    return;
  }
...
const data = result.data;
    ...
    if (
      ...
      toast.error(
        "Patient registration blocked by security policy."
      );
    ...
    toast.success(
      "Patient registered and added to clinic queue! 🎉"
    );
